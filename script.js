$.getJSON("http://api.openweathermap.org/data/2.5/weather?q=Anaheim&units=imperial&appid=4c5793fc59034c04babb0d0021abfcc3",function(data){
console.log(data);
...
$.getJSON('http://api.openweathermap.org/data/2.5/forecast?q=Anaheim&units=imperial&appid=4c5793fc59034c04babb0d0021abfcc3',function(data){
    console.log(data);
